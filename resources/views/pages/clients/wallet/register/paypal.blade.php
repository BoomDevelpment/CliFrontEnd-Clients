                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="p_asu" id="p_asu" placeholder="T&iacute;tulo de registro">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" class="form-control" name="p_amount" id="p_amount" placeholder="Correo electr&oacute;nico de transferencia">
                                    <span class="messages"></span>
                                </div>
                            </div>
                        </div>
