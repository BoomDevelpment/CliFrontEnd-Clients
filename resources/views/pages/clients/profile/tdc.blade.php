                        ...
                        <div>
                            @foreach($cc_entity as $ent)
                                @if($tc->entity_id == $ent->id)
                                    <td><img src="{{ $ent->path }}" id="amex" alt="{{ $ent->name }}"></td>
                                @endif
                            @endforeach
                            <h5>**** **** ** {{ $tc->last }}</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group" id="debit-cards" style="text-align: center;">
                                                <img src="/images/card/visa.jpg" id="visa" alt="visa.jpg">
                                                <img src="/images/card/mastercard.jpg" id="mastercard" alt="mastercard.jpg">
                                                <img src="/images/card/amex.jpg" id="amex" alt="amex.jpg">
                                            </div>
                                    ...
                                    <tbody>
                                        @foreach($tdc as $tc)
                                            <tr>
                                                ...
                                                @foreach($cc_entity as $ent)
                                                    @if($tc->entity_id == $ent->id)
                                                        <td><img src="{{ $ent->path }}" style="width: 25px;" id="amex" alt="{{ $ent->name }}"></td>
                                                    @endif
                                                @endforeach
                                                <td>XXXX-{{ $tc->last }}</td>
