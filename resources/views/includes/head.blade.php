...
<link rel="icon" type="image/x-icon" href="{{ asset('src/assets/images/favicon.ico') }}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('src/assets/pages/prism/prism.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('src/assets/css/style.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('src/assets/css/jquery.mCustomScrollbar.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('src/assets/css/pcoded-horizontal.min.css') }}">
